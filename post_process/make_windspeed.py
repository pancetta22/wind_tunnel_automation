...
# 風速較正のデフォルト（experiment_log.json や --offset/--a/--b/--water_dens が
# 無い場合のフォールバック）。flutter_analysis.py も同じ値を使うため、
# ここをモジュールレベル定数にして import させ、二重管理を避ける。
WINDSPEED_DEFAULTS = {
